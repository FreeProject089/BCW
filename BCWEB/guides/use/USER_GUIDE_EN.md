...
- On Discord: `/level`, `/shop`, `/inventory`, `/gift`, `/history`, `/leaderboard` (this server or global, as a picture, with your own rank), `/profile`, and `/casino` (an animated table — coin flip, dice, slots, roulette with colour / green / number bets, wheel, plinko).
