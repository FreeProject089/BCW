...
- Sur Discord : `/level`, `/shop`, `/inventory`, `/gift`, `/history`, `/leaderboard` (ce serveur ou global, en image, avec ton propre rang), `/profile`, et `/casino` (une table animée — pile ou face, dés, machine à sous, roulette avec mise couleur / vert / numéro, roue, plinko).
