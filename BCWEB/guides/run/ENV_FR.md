...
| Variable | Rôle |
|---|---|
| `VITE_GTM_ID` | Id Google Tag / GA4. **Préférez le dashboard** (Réglages d’hébergement → Recherche & visibilité) : sans rebuild. Celle-ci est figée au build et l’emporte. Soumise au consentement dans les deux cas. |
