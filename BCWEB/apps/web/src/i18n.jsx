...
const DICT = {
  ...
  fr: {
    ...
    'adm.tab.events': 'Événements', 'common.edit': 'Modifier',
    // ── Événements du site ──
    'evadm.title': 'Événements du site',
    'evadm.sub': 'Des fenêtres programmées avec un thème visuel (neige, feux d’artifice, cœurs…) et/ou une remise automatique sur tout ce qui est acheté pendant. Les visiteurs peuvent désactiver les visuels dans les Réglages ; la tarification s’applique toujours.',
    'evadm.needname': 'Donne un nom à l’événement.', 'evadm.saved': 'Événement enregistré — actif sur tout le site pendant sa fenêtre.', 'evadm.dates': 'La fin doit être après le début.',
    'evadm.del.t': 'Supprimer l’événement ?', 'evadm.del.ok': 'Supprimer',
    'evadm.disabled': 'désactivé', 'evadm.upcoming': 'à venir', 'evadm.past': 'passé', 'evadm.live': 'EN COURS',
    'evadm.name': 'Nom (affiché sur les badges/bannière)', 'evadm.theme': 'Thème visuel',
    'evadm.flag': 'Emoji drapeau', 'evadm.flag.h': 'Même effet de feux d’artifice, c’est ce drapeau qui pleut (🇨🇭 🇫🇷 🇺🇸 …).',
    'evadm.start': 'Début', 'evadm.end': 'Fin',
    'evadm.pct': 'Remise % (0 = visuel uniquement)', 'evadm.pct.h': 'Appliquée automatiquement au paiement sur tout ce qui est acheté pendant la fenêtre — un prépayé d’1 an a la remise complète ; les renouvellements ultérieurs sont plein tarif.',
    'evadm.scope': 'La remise s’applique à', 'evadm.scope.all': 'Tous les articles (hébergement + boosts)', 'evadm.scope.hosting': 'Hébergement uniquement', 'evadm.scope.boost': 'Boosts uniquement',
    'evadm.note': 'Note (interne)', 'evadm.enabled': 'Activé', 'evadm.update': 'Mettre à jour', 'evadm.create': 'Créer l’événement',
    'evadm.disable': 'Désactiver', 'evadm.enable': 'Activer',
    'evadm.none.t': 'Aucun événement', 'evadm.none.s': 'Utilise un preset ci-dessus ou crées-en un — thème, dates, et remise automatique optionnelle.',
    'evadm.overlaps': 'Un SEUL événement à la fois — cette fenêtre chevauche « {n} ». Change les dates ou désactive-le d’abord.',
    'evadm.fx': 'Éditeur d’effets', 'evadm.fx.h': '— règle les visuels ; ce qui n’est pas touché garde les valeurs par défaut du thème',
    'evadm.fx.density': 'Densité', 'evadm.fx.intensity': 'Intensité feux d’artifice', 'evadm.fx.speed': 'Vitesse', 'evadm.fx.size': 'Taille', 'evadm.fx.opacity': 'Opacité', 'evadm.fx.wind': 'Vent', 'evadm.fx.confetti': 'Confettis / drapeaux',
    'evadm.fx.glyphs': 'Particules personnalisées (emoji — remplace celles du thème)', 'evadm.fx.glyphs.h': 'ex. 🎃👻🦇 ou ❄️⛄ — vide = celles du thème.',
    'evadm.fx.strip': 'Illustration saisonnière en bas', 'evadm.fx.fog': 'Brouillard', 'evadm.fx.sound': 'Bouton sons spooky', 'evadm.fx.countdown': 'Compteur de minuit',
    'evadm.fx.reset': 'Réinitialiser', 'evadm.fx.preview': 'Prévisualiser sur cette page', 'evadm.fx.stoppreview': 'Arrêter la prévisualisation',
    'evadm.fx.kind': 'Comportement', 'evadm.fx.kind.h': 'Comment tes particules bougent.',
    'evadm.fx.kind.fall': 'Chute (comme des feuilles)', 'evadm.fx.kind.rise': 'Montée (comme des cœurs)', 'evadm.fx.kind.float': 'Flottement & pulsation (comme des fantômes)', 'evadm.fx.kind.snow': 'Neige (points doux + icônes)', 'evadm.fx.kind.fireworks': 'Feux d’artifice + confettis',
    'evadm.fx.icons': 'Icônes des particules (vectoriel — remplace celles du thème)', 'evadm.fx.icons.h': 'Aucune sélection = les icônes par défaut du thème. Max 8.',
    'evadm.fx.colors': 'Palette de couleurs (particules / confettis)', 'evadm.fx.colors.h': 'Vide = la couleur naturelle de chaque icône (défaut du thème).',
    'evadm.fx.overlay': 'Particules devant le contenu', 'evadm.fx.overlay.h': 'Par défaut : les particules sont dessinées DERRIÈRE le contenu, le texte reste parfaitement lisible.',
    'evadm.notifysoon': 'Notification — 7 jours avant (vide = auto)', 'evadm.notifysoon.h': 'Envoyée UNE fois par utilisateur qui visite le site dans les 7 jours avant le début.', 'evadm.notifysoon.ph': '🎉 Le Black Friday commence le 24 nov — −30% sur tout !',
    'evadm.notifystart': 'Notification — au lancement (vide = auto)', 'evadm.notifystart.h': 'Envoyée UNE fois par utilisateur qui visite pendant l’événement.', 'evadm.notifystart.ph': '🎊 Le Black Friday est EN COURS — −30% jusqu’au 1er déc !',
    'ev.endsin': 'fini dans {n}j',
    'set.eventfx': 'Effets d’événements saisonniers', 'set.eventfx.d': 'Neige, feux d’artifice, cœurs et autres décorations pendant les événements du site. Les bannières promo restent dans tous les cas.',
