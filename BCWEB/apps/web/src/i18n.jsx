...
const DICT = {
  ...
  fr: {
    ...
    'sp.alloc.note2': 'CPU et Envoi sont réservés par le forfait de chaque dépôt (pas la consommation réelle). Le stockage indique ce qui est vraiment stocké sur le quota.',
