...
const DICT = {
  en: {
    ...
    'auth.err.creds': 'Wrong email or password.', 'auth.err.taken': 'This email already exists.', 'auth.err.taken.login': 'Login instead?',
  ...
  fr: {
    ...
    'twofa.nudge.d': "Ajoute un second facteur pour qu'un mot de passe fuité seul ne suffise pas. Ça prend environ une minute — c'est optionnel.",
    'twofa.nudge.later': "Plus tard",
    'twofa.nudge.setup': "Configurer",
    'twofa.nudge.title': "Sécurise ton compte avec la 2FA",
    ...
    'auth.err.creds': 'E-mail ou mot de passe incorrect.', 'auth.err.taken': 'Cet e-mail existe déjà.', 'auth.err.taken.login': 'Se connecter plutôt ?',
