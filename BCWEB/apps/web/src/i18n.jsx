...
const DICT = {
  ...
  fr: {
    ...
    'ev.title': "Flux d'événements", 'ev.sub': 'Le flux en direct de ce que font les visiteurs — pages vues, clics, envois de formulaire, saisies. Anonyme (identité qui tourne chaque jour, aucune donnée perso).',
    'ev.pathph': 'Filtrer par chemin de page…', 'ev.filter': 'Filtrer', 'ev.none': 'Aucun événement sur cette période', 'ev.none.s': 'Ajuste la période ou les filtres.',
