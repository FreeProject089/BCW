...
const DICT = {
  ...
  fr: {
    ...
    'ud.cl.start.m': "La personne reçoit le motif, la date et un lien pour nous contacter — pas un bouton d’annulation, car une fermeture décidée par l’équipe ne s’annule pas d’un clic de son côté. Rien n’est supprimé avant le {d} ; tu peux annuler jusque-là.",
