...
/** The products, as rows with an action rather than cards of prose. */
...
export function NewsGrid({ posts = [], limit = 3, heading = true }) {
  const { t } = useI18n();
...
/** Testimonials. */
export function ReviewsCard({ reviewsData, limit = 3 }) {
