  ...
  return [
    ...
    },
    {
      ...
      rows: [
        ...
        ['shift+1', t('cst.keys.showall', 'Show everything, blocks off the frame included')],
        [t('cst.keys.wheel', 'Wheel, pinch'), t('cst.keys.wheel.h', 'Zoom about the pointer')],
        [t('cst.keys.panwith', 'Space, middle button, two fingers'), t('cst.keys.pan', 'Move the board')],
