...
import { detailMaxFor } from './scene-config.js';
...
// M18 (agent-perf-M18): the settings fetch and the reveal switch live in scene-read.js, which
// does not import three.js, because main.jsx calls them on every page. Re-exported here so
// Hero3D and every other `from './scene-shapes.js'` keep working.
export { applyReveal, readSceneConfig } from './scene-read.js';
