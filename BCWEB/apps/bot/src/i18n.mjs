...
export const BASE = {
  en: {
    ...
    'level.waiting': '💰 **{n}** {cur} waiting — link your BetterCommunity account to spend, give or receive them.',
    ...
    'stat.messages': '💬 **{n}** messages', 'stat.reactions': '✨ **{n}** reactions', 'stat.voice': '🎙️ **{h} h {m} min** in voice',
    ...
    'cas.win': '{g} — you win!', 'cas.push': '{g} — push', 'cas.lose': '{g} — you lose', 'cas.won': '🎉 You won **+{n}** — balance **{b}**.', 'cas.pushed': '↩️ Push — your **{n}** came back. Balance **{b}**.',
  ...
  fr: {
    ...
    'level.waiting': '💰 **{n}** {cur} en attente — lie ton compte BetterCommunity pour les dépenser, donner ou recevoir.',
    ...
    'stat.messages': '💬 **{n}** messages', 'stat.reactions': '✨ **{n}** réactions', 'stat.voice': '🎙️ **{h} h {m} min** en vocal',
    ...
    'cas.win': '{g} — gagné !', 'cas.push': '{g} — nul', 'cas.lose': '{g} — perdu', 'cas.won': '🎉 Tu gagnes **+{n}** — solde **{b}**.', 'cas.pushed': '↩️ Nul — tes **{n}** te reviennent. Solde **{b}**.',
  ...
  de: {
    ...
    'level.waiting': '💰 **{n}** {cur} warten — verknüpfe dein BetterCommunity-Konto, um sie auszugeben, zu verschenken oder zu erhalten.',
    ...
    'stat.messages': '💬 **{n}** Nachrichten', 'stat.reactions': '✨ **{n}** Reaktionen', 'stat.voice': '🎙️ **{h} h {m} min** im Sprachkanal',
    ...
    'cas.win': '{g} — gewonnen!', 'cas.push': '{g} — unentschieden', 'cas.lose': '{g} — verloren', 'cas.won': '🎉 Du gewinnst **+{n}** — Guthaben **{b}**.', 'cas.pushed': '↩️ Unentschieden — deine **{n}** kommen zurück. Guthaben **{b}**.',
  ...
  es: {
    ...
    'level.waiting': '💰 **{n}** {cur} esperando — vincula tu cuenta de BetterCommunity para gastarlos, darlos o recibirlos.',
    ...
    'stat.messages': '💬 **{n}** mensajes', 'stat.reactions': '✨ **{n}** reacciones', 'stat.voice': '🎙️ **{h} h {m} min** en voz',
    ...
    'cas.win': '{g} — ¡ganaste!', 'cas.push': '{g} — empate', 'cas.lose': '{g} — perdiste', 'cas.won': '🎉 Ganaste **+{n}** — saldo **{b}**.', 'cas.pushed': '↩️ Empate — tus **{n}** vuelven. Saldo **{b}**.',
