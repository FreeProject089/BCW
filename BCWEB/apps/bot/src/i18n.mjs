...
export const BASE = {
  en: {
    ...
    'live.rules.race': 'Six cars, one lap. Pick yours; the winner pays **6×**.',
    ...
    'live.rules.multi': 'One roll for everybody. Each player bets against the house on the same outcome.',
  ...
  fr: {
    ...
    'live.rules.race': 'Six voitures, un tour. Choisis la tienne ; la gagnante paie **6×**.',
    ...
    'live.rules.multi': 'Un seul tirage pour tout le monde. Chaque joueur mise contre la maison sur le même résultat.',
  ...
  de: {
    ...
    'live.rules.race': 'Sechs Autos, eine Runde. Wähl deins; der Sieger zahlt **6×**.',
    ...
    'live.rules.multi': 'Ein Wurf für alle. Jeder setzt gegen die Bank auf dasselbe Ergebnis.',
  ...
  es: {
    ...
    'live.rules.race': 'Seis coches, una vuelta. Elige el tuyo; el ganador paga **6×**.',
    ...
    'live.rules.multi': 'Una sola tirada para todos. Cada jugador apuesta contra la casa sobre el mismo resultado.',
